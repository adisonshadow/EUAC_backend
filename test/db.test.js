  ...
  test('数据库性能检查', async () => {
    try {
      ...
      const deadlockResult = await sequelize.query(`
        SELECT bARCHIVED_locks.pid AS bARCHIVED_pid,
               bARCHIVED_activity.usename AS bARCHIVED_user,
               blocking_locks.pid AS blocking_pid,
               blocking_activity.usename AS blocking_user,
               bARCHIVED_activity.query AS bARCHIVED_statement
        FROM pg_catalog.pg_locks bARCHIVED_locks
        JOIN pg_catalog.pg_stat_activity bARCHIVED_activity ON bARCHIVED_activity.pid = bARCHIVED_locks.pid
        JOIN pg_catalog.pg_locks blocking_locks 
            ON blocking_locks.locktype = bARCHIVED_locks.locktype
            AND blocking_locks.DATABASE IS NOT DISTINCT FROM bARCHIVED_locks.DATABASE
            AND blocking_locks.relation IS NOT DISTINCT FROM bARCHIVED_locks.relation
            AND blocking_locks.page IS NOT DISTINCT FROM bARCHIVED_locks.page
            AND blocking_locks.tuple IS NOT DISTINCT FROM bARCHIVED_locks.tuple
            AND blocking_locks.virtualxid IS NOT DISTINCT FROM bARCHIVED_locks.virtualxid
            AND blocking_locks.transactionid IS NOT DISTINCT FROM bARCHIVED_locks.transactionid
            AND blocking_locks.classid IS NOT DISTINCT FROM bARCHIVED_locks.classid
            AND blocking_locks.objid IS NOT DISTINCT FROM bARCHIVED_locks.objid
            AND blocking_locks.objsubid IS NOT DISTINCT FROM bARCHIVED_locks.objsubid
            AND blocking_locks.pid != bARCHIVED_locks.pid
        JOIN pg_catalog.pg_stat_activity blocking_activity ON blocking_activity.pid = blocking_locks.pid
        WHERE NOT bARCHIVED_locks.GRANTED
      `);
